import 'package:cube_tracker/main.dart';
...
class _CubeTrackerState extends State<CubeTracker> {
  ...
  void sendNotification(int cubeId, String notificationType) {
    // استخدام مكتبة لإرسال الإشعارات مثل flutter_local_notifications
    print("Notification for Cube ID: $cubeId, Type: $notificationType");
  }
